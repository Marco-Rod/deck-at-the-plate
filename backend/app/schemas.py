...
class TacticCardResponse(BaseModel):
    id: str
    name: str
    category: str
    target_role: str
...
class CreateGameRequest(BaseModel):
    ...
    home_pitcher_id: str
    away_pitcher_id: str
    home_lineup: List[str] = Field(..., min_items=9, max_items=9, description="Lista de 9 IDs de cartas de bateadores locales")
    away_lineup: List[str] = Field(..., min_items=9, max_items=9, description="Lista de 9 IDs de cartas de bateadores visitantes")
