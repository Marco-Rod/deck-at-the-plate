...
class PlayerCardModel(Base):
    ...
    # --- Campos de migración (additivos; No-borrar name/team/number/position en V1) ---
    # Snapshot estadístico/fuente usado al generar la carta. Nullable para legacy/manuales.
...
class TacticCard(Base):
    ...
    # Versión del contrato de `effects`. Permite evolucionar sin romper cartas tácticas.
    effect_schema_version = Column(Integer, nullable=False, default=1)