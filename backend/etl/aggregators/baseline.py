...
def batter_season_row(player_season_id: str, counter: BatterCounter) -> dict:
    return {
        ...
        "chases": counter.chases,
        "chase_opportunities": counter.chase_opportunities,
        "hard_hits": counter.hard_hits,
        "hard_hit_opportunities": counter.hard_hit_opportunities,
        "barrels": counter.barrels,
        "barrel_opportunities": counter.barrel_opportunities,
        "avg": counter.avg,
        "obp": counter.obp,
        "slg": counter.slg,
        "ops": counter.ops,
