...
def test_parser_generates_subcomandos():
    ...
    commands = {
        ...
        "build-rating-distribution": ["build-rating-distribution", "--season", "2026", "--role", "batter", "--from", "2026-03-20", "--to", "2026-08-31", "--performance-tier-model-version", "rarity-2.0"],
        ...
        "calculate-batter-vision": ["calculate-batter-vision", "--player-id", "660271", "--season", "2026", "--from", "2026-03-20", "--to", "2026-08-31"],
        "calculate-batter-ratings": ["calculate-batter-ratings", "--player-id", "660271", "--season", "2026", "--from", "2026-03-20", "--to", "2026-08-31"],
        "persist-batter-ratings": ["persist-batter-ratings", "--player-id", "660271", "--season", "2026", "--from", "2026-03-20", "--to", "2026-08-31"],
        ...
        "generate-batter-ratings-population": ["generate-batter-ratings-population", "--season", "2026", "--from", "2026-03-20", "--to", "2026-08-31"],
