...
/**
 * RivalPitcherChangeModal - Dual Mode Modal
 * 
 * Mode 1: Notification - Shows old pitcher → new pitcher (oldPitcher + newPitcher provided)
 * Mode 2: Selection - Shows pitcher selection UI (availablePitchers provided)
 */
export const RivalPitcherChangeModal: React.FC<RivalPitcherChangeModalProps> = ({
  ...
  // ─── NOTIFICATION MODE ──────────────────────────────────────────────────
  // When showing a pitcher change that already happened
            ...
            >
              <div className="bg-gradient-to-br from-[#1a1d23] via-[#0f1219] to-[#0a0d0f] border-2 border-[#C5A059]/60 rounded-lg shadow-2xl p-6 sm:p-8 md:p-10 max-w-lg w-full mx-4 pointer-events-auto">
                ...
                <div className="flex justify-center mb-6">
                  <div
                    className="text-[10px] sm:text-xs font-mono font-bold uppercase tracking-wider px-3 py-1 rounded border"
                    style={{
  ...
  // ─── SELECTION MODE ─────────────────────────────────────────────────────
  // When user needs to select from available pitchers
